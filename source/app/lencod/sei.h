...
#if NNPF_ENABLE
#define MAX_NUM_NN_POST_FILTERS 8
typedef struct
{
...
struct sei_params {
  ...
  NNPFASEI seiNNPFA;
  Boolean seiHasNNPFC;
  unsigned int nnpfc_num_filters;
  NNPFCSEI seiNNPFC[MAX_NUM_NN_POST_FILTERS];
#endif
...
#if NNPF_ENABLE
extern  void UpdateNNPFC(SEIParameters *p_SEI); 
extern  void UpdateNNPFA(SEIParameters *p_SEI); 
#endif
